...
* [**_net10.0_**](net10.0.md) contains the reflected classes generated from .NET 10, divided by the containing assembly

**JCOReflector** is the folder of common classes for both **.NET** **Framework**, **8**, **9** and **10**
